...
- **Lenis:** the homepage hero owns the single document-level instance. Never add a second instance or smooth-scroll an inner document without an approved interaction need.
